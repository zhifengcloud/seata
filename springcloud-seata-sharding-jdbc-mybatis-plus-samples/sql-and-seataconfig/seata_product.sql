...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`seata_product` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `product_info`(`id`,`product_name`,`stock`,`create_time`,`update_time`) values (1,'蓝牙耳机',9998,'2021-04-28 19:25:39','2021-04-28 20:26:30');
insert  into `product_info`(`id`,`product_name`,`stock`,`create_time`,`update_time`) values (2,'苹果12',1000,'2021-05-28 19:25:39','2021-04-28 20:26:30');
